  ...
  return (
    <>
      ...
      <header>
        ...
        {/* title */}
        <p className="title-name">Kaito Portfolio</p>

        {/* description */}
        <div className='description'>
          <p>I'm iOSProgrammer</p>
          <p>studying web applications right now✏️.</p>
        </div>
        <a href="/about" className='link'>Read more <ArrowRight /> </a>

        {/* social media */}
        <div className="socialmedia">

          <a href='https://github.com/Kaito1108'> 
          ...
          <a href='https://x.com/tkaito1108' style={{marginLeft: '20px'}}> 
